...
// Sub-components for the specific styles requested
...
const TopKPI = ({ title, mainValue, mainTrend, subTitle1, subVal1, subTitle2, subVal2, upIsGood = true }) => {
...
export default function Performance() {
  ...
  return (
      ...
      {/* Main Content Area */}
      <div className="flex-1 flex flex-col gap-3"><div className="bg-white border border-slate-200 rounded-lg p-3 shadow-sm flex items-center justify-center">
          <h1 className="text-xl font-bold text-slate-700">Production Metrics Dashboard for Manufacturing</h1>
        </div>
