    ...
    <div className="pb-4 max-w-[1600px] mx-auto px-1 flex flex-col gap-3 h-full">
      ...
      <div className="flex-1 flex flex-col gap-3">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
          <StatCard title="Total Engine Count" value="100" color="bg-blue-100" />
          <StatCard title="Models Count" value="3" color="bg-purple-100" />
          <StatCard title="Oldest Entry Age" value="2 Days" color="bg-orange-100" />
        </div>
