    ...
    <div className="pb-4 max-w-[1600px] mx-auto px-1 flex flex-col gap-3 h-full">
      ...
      <div className="flex-1 flex flex-col gap-3">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
          <StatCard title="Total Inspected" autoScale value="150" color="bg-blue-100" />
          <StatCard title="OK" autoScale value="130" color="bg-green-100" />
          <StatCard title="NOK" autoScale value="20" color="bg-red-100" />
          <StatCard title="Pass Rate %" autoScale value="86.6%" color="bg-purple-100" />
        </div>
