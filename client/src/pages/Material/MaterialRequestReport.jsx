    ...
    <div className="pb-4 max-w-[1600px] mx-auto px-1 flex flex-col gap-3 h-full">
      ...
      <div className="flex-1 flex flex-col gap-3">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
          <StatCard autoScale title="Total Requests"  value="40" color="bg-blue-100" />
          <StatCard autoScale title="Fulfilled"  value="35" color="bg-green-100" />
          <StatCard autoScale title="Pending"  value="5" color="bg-orange-100" />
          <StatCard autoScale title="Avg Fulfillment Time (mins)"  value="12" color="bg-purple-100" />
        </div>
