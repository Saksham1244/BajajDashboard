    ...
    <div className="pb-4 max-w-[1600px] mx-auto px-1 flex flex-col gap-3 h-full">
      ...
      <div className="flex-1 flex flex-col gap-3">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
          <StatCard title="Avg Speed (m/min)" value={kpi.avgSpeed} />
          <StatCard title="Max Speed Deviation" value={kpi.maxDeviation} color="text-red-500" />
          <StatCard title="Total Stoppages" value={kpi.totalStoppages} />
          <StatCard title="Conveyor Efficiency %" value={kpi.efficiency} color="text-green-600" />
        </div>
