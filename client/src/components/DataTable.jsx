      ...
      <div className="overflow-x-auto print:overflow-visible">
        <table className="w-full text-left border-collapse">
          ...
          <tbody>
            {data.length === 0 ? (
              <tr>
                <td colSpan={Math.max(1, cols.length)} className="py-8 text-center text-slate-400 text-sm font-medium">
                  <div className="flex flex-col items-center justify-center gap-1.5 py-4">
                    <Database className="w-6 h-6 text-slate-300 stroke-[1.5]" />
                    <span className="text-slate-500 font-medium">No data available in the database</span>
                  </div>
                </td>
              </tr>
            ) : (
